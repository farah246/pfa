...
\begin{itemize}[leftmargin=3.2cm, labelwidth=3cm, align=left, itemsep=6pt]
  ...
  \item[\textbf{Jaeger}] Système de traçage distribué permettant de suivre les requêtes
        à travers les différents microservices du cluster.
  ...
  \item[\textbf{OWASP ZAP}] Zed Attack Proxy --- outil de test de sécurité dynamique
        (DAST) open source, utilisé pour l'analyse des vulnérabilités des API exposées.
